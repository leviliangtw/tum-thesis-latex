...
\begin{figure}[htpb]
  ...
  \begin{tikzpicture}[
    ...
    \node (LB1) [node distance=2cm, below=of C, text width=6em, node, fill=red!10] {Load\\Balancer};
    \node (LB2) [node distance=3cm, left=of LB1, text width=6em, node, fill=red!10] {Load\\Balancer};
    \node (Prober1) [node distance=3cm, below=of LB1.west, text width=6em, node, fill=red!10] {TCIL\\Probers};
    \node (Prober2) [node distance=3cm, below=of LB2.west, text width=6em, node, fill=red!10] {Blackbox\\Exporters};
    \node (LB1Z) [zone, dashed, rounded corners, fit={(LB1) (Prober1)}] {};
    \node (LB2Z) [zone, dashed, rounded corners, fit={(LB2) (Prober2)}] {};
    \node (PO) [node distance=5cm, right=of LB1.west, text width=6em, node, fill=red!10] {Prometheus\\Operator};
    ...
    \node (UZ) [zone, dashed, fit={(LB1) (LB2) (Prober1) (Prober2) (LB1Z) (LB2Z) (PO) (PA) (PAZ) (CRDPA) (CRDP)}] {};
    \node (U) [node distance=6pt, above=of UZ.north west, zonetag, anchor=west] {Active Monitoring Platform};

    \node (TS1) [node distance=3cm, below=of Prober1.west, text width=6em, node, fill=green!10] {Target\\Service\ 1};
    \node (C1Z) [zone, dashed, fit={(TS1)}] {};
    \node (C1) [node distance=2pt, below=of C1Z, zonetag] {Product A};

    \node (TS2) [node distance=3cm, below=of Prober2.west, text width=6em, node, fill=green!10] {Target\\Service\ 2};
    \node (C2Z) [zone, dashed, fit={(TS2)}] {};
    \node (C2) [node distance=2pt, below=of C2Z, zonetag] {Product B};

    \node (TR) [node distance=3cm, below=of PA.west, text width=6em, node, fill=green!10] {Thanos\\Receive};
    \node (GZ) [zone, dashed, fit={(TR)}] {};
    \node (G) [node distance=2pt, below=of GZ, zonetag] {Amadeus Observability Platform};

    \node (CZ) [zone, fit={(U) (LB1) (LB2) (Prober1) (Prober2) (PO) (PA) (CRDPA) (CRDP) (UZ) (G) (GZ) (TR) (TS1) (TS2) (C1) (C1Z)}] {};
